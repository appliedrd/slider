 ...
 */
$(function () {
    $('input[type=checkbox][name=hasRange]').change(function() {
        if( $(this).is(":checked") ){
            $( "#showMinMax" ).show();
        }
        else  {
    ...
    $('input[type=checkbox][name=addSliderv]').change(function() {
        if( $(this).is(":checked") ){
            $( "#showSlider" ).show();
        }
        else  {
    ...
    $('input[type=checkbox][name=hasPips]').change(function() {
        if( $(this).is(":checked") ){
            $( "#addSteps" ).show();
        }
        else  {
    ...
    $("#sliderForm").submit(function (event) {
        if ($('#sliderForm').valid()) {
            ...
            $("#sliderFornErrors").text("errors on form");
            $( "#sliderWidget" ).hide();
        }
